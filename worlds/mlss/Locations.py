...
mainArea: typing.List[LocationData] = [
    ...
    LocationData("Beanbean Outskirts Secret Scroll 1", 0x1E9411, 0x1E9411, 2),
    LocationData("Beanbean Outskirts Secret Scroll 2", 0x1E9412, 0x1E9412, 2),
    LocationData("Beanbean Outskirts Bean Fruit 1", 0x229345, 0x229345, 1),
    LocationData("Beanbean Outskirts Bean Fruit 2", 0x22954D, 0x22954D, 1),
    LocationData("Beanbean Outskirts Bean Fruit 3", 0x228A17, 0x228A17, 1),
    LocationData("Beanbean Outskirts Bean Fruit 4", 0x22913A, 0x22913A, 1),
    LocationData("Beanbean Outskirts Bean Fruit 5", 0x22890E, 0x22890E, 1),
    LocationData("Beanbean Outskirts Bean Fruit 6", 0x228775, 0x228775, 1),
    LocationData("Beanbean Outskirts Bean Fruit 7", 0x1E9431, 0x1E9431, 2),
    LocationData("Hoohoo Village Mole Behind Turtle", 0x277AB2, 0x277AB2, 1),
    LocationData("Beanbean Outskirts Thunderhand Mole", 0x2779C8, 0x2779C8, 1),
    LocationData("Hoohoo Mountain Peasley's Rose", 0x1E9430, 0x1E9430, 2),
    LocationData("Beanbean Outskirts Super Hammer Upgrade", 0x1E9404, 0x1E9404, 2),
    LocationData("Beanbean Outskirts Ultra Hammer Upgrade", 0x1E9405, 0x1E9405, 2),
    LocationData("Beanbean Outskirts NE Solo Mario Mole 1", 0x1E9435, 0x1E9435, 2),
    LocationData("Beanbean Outskirts NE Solo Mario Mole 2", 0x1E9436, 0x1E9436, 2),
    LocationData("Hoohoo Village Hammers", 0x1E9403, 0x1E9403, 2),
    LocationData("Beanbean Outskirts Solo Luigi Cave Mole", 0x242888, 0x242888, 1),
    LocationData("Beanbean Outskirts Farm Room Mole Reward 1", 0x243844, 0x243844, 1),
    LocationData("Beanbean Outskirts Farm Room Mole Reward 2", 0x24387D, 0x24387D, 1),
...
specialCoins: typing.List[LocationData] = [
    LocationData("Stardust Fields Room 2 Coin Block 4", 0xD40080, 0xD40080, 0),
    LocationData("Stardust Fields Room 3 Coin Block 3", 0xD400A5, 0xD400A5, 0),
    LocationData("Stardust Fields Room 5 Coin Block 3", 0xD400DF, 0xD400DF, 0),
    LocationData("Stardust Fields Room 7 Coin Block 3", 0xD40123, 0xD40123, 0),
    LocationData("Beanbean Castle Coin Block", 0xD40243, 0xD40243, 0),
    LocationData("Hoohoo Mountain Fountain Room Coin Block", 0xD40312, 0xD40312, 0),
    LocationData("Hoohoo Mountain Base East of Bridge Room Coin Block", 0xD40366, 0xD40366, 0),
    LocationData("Hoohoo Mountain Base Grassy Area Coin Block", 0xD40428, 0xD40428, 0),
    LocationData("Hoohoo Village North Cave Room 2 Coin Block", 0xD404E7, 0xD404E7, 0),
    LocationData("Hoohoo Mountain Base Boostatue Cave Coin Block 4", 0xD4053C, 0xD4053C, 0),
    LocationData("Chateau Barrel Room Coin Block", 0xD4079F, 0xD4079F, 0),
    LocationData("Chucklehuck Woods Room 7 Coin Block 2", 0xD40893, 0xD40893, 0),
    LocationData("Winkle Area Coin Block", 0xD40980, 0xD40980, 0),
    LocationData("Chucklehuck Woods Winkle Area Cave Coin Block 2", 0xD409DA, 0xD409DA, 0),
    LocationData("Oho Oasis Outside Fire Palace Coin Block", 0xD409F6, 0xD409F6, 0),
    LocationData("Oho Oasis Thunder Palace Coin Block", 0xD40A38, 0xD40A38, 0),
    LocationData("Woohoo Hooniversity Barrel Puzzle Entrance Coin Block", 0xD40C32, 0xD40C32, 0),
    LocationData("Woohoo Hooniversity West of Star Room 4 Coin Block", 0xD40C8E, 0xD40C8E, 0),
    LocationData("Woohoo Hooniversity Entrance to Mini Mario Room 2 Coin Block", 0xD40CC5, 0xD40CC5, 0),
    LocationData("Woohoo Hooniversity Past Cackletta Room 2 Coin Block", 0xD40D3F, 0xD40D3F, 0),
    LocationData("Woohoo Hooniversity Past Cackletta Room 3 Coin Block", 0xD40D4C, 0xD40D4C, 0),
    LocationData("Airport Entrance Coin Block", 0xD40D7E, 0xD40D7E, 0),
    LocationData("Airport Eastside Coin Block", 0xD40DC0, 0xD40DC0, 0),
    LocationData("Gwarhar Lagoon Pipe to Oho Ocean Room Coin Block", 0xD40E37, 0xD40E37, 0),
    LocationData("Gwarhar Lagoon Massage Parlor Entrance Coin Block", 0xD40E52, 0xD40E52, 0),
    LocationData("Gwarhar Lagoon Stone Bridge Room Coin Block", 0xD40E72, 0xD40E72, 0),
    LocationData("Teehee Valley Room 2 Coin Block", 0xD41019, 0xD41019, 0),
    LocationData("S.S. Chuckola East of Entrance Coin Block", 0xD4110C, 0xD4110C, 0),
    LocationData("Joke's End West of First Boiler Room Coin Block", 0xD411CD, 0xD411CD, 0),
    LocationData("Joke's End Northeast of Boiler Room 3 Coin Block", 0xD41227, 0xD41227, 0),
    LocationData("Joke's End Northeast of Boiler Room 2 Coin Block", 0xD41244, 0xD41244, 0),
    LocationData("Joke's End Furnace Room 2 Coin Block", 0xD41339, 0xD41339, 0),
    LocationData("Joke's End North of Second Boiler Room Coin Block", 0xD4136E, 0xD4136E, 0),
    LocationData("Fungitown Embassy Building Room 1 Coin Block", 0xD41399, 0xD41399, 0),
    LocationData("Fungitown Embassy Building Room 2 Coin Block", 0xD413A6, 0xD413A6, 0),
    LocationData("Fungitown Psycho Kamek House Coin Block", 0xD413C9, 0xD413C9, 0),
    LocationData("Bowser's Castle Lemmy Room 1 Coin Block", 0xD415CC, 0xD415CC, 0),
    LocationData("Bowser's Castle Roy Room 1 Coin Block", 0xD415FB, 0xD415FB, 0),
    LocationData("Bowser's Castle Roy Room 4 Coin Block", 0xD41632, 0xD41632, 0),
    LocationData("Woohoo Hooniversity Prototype Room 1 Block", 0xD4172F, 0xD4172F, 0),
    LocationData("Woohoo Hooniversity Prototype Room 2 Block 1", 0xD4173C, 0xD4173C, 0),
    LocationData("Woohoo Hooniversity Prototype Room 2 Block 2", 0xD41744, 0xD41744, 0),
    LocationData("Woohoo Hooniversity Prototype Room 2 Block 3", 0xD4174C, 0xD4174C, 0),
    LocationData("Woohoo Hooniversity Prototype Room 2 Block 4", 0xD41754, 0xD41754, 0),
    LocationData("Woohoo Hooniversity Prototype Room 3 Block 1", 0xD41761, 0xD41761, 0),
    LocationData("Woohoo Hooniversity Prototype Room 3 Block 2", 0xD41769, 0xD41769, 0),
]
...
baseUltraRocks: typing.List[LocationData] = [
    ...
    LocationData("Hoohoo Mountain Base Mole Near Teehee Valley", 0x277A45, 0x277A45, 1),
...
booStatue: typing.List[LocationData] = [
    ...
    LocationData("Beanstar Piece Harhall", 0x1E9441, 0x1E9441, 2),
    LocationData("Beanbean Outskirts Boostatue Mole", 0x1E9434, 0x1E9434, 2),
    LocationData("Harhall's Pants", 0x1E9444, 0x1E9444, 2),
...
chucklehuck: typing.List[LocationData] = [
    ...
    LocationData("Chateau Green Goblet", 0x24E628, 0x24E628, 1),
    LocationData("Chateau Red Goblet", 0x1E943E, 0x1E943E, 2),
    LocationData("Chucklehuck Woods Red Chuckola Fruit", 0x250621, 0x250621, 2),
    LocationData("Chucklehuck Woods White Chuckola Fruit", 0x24FF18, 0x24FF18, 2),
    LocationData("Chucklehuck Woods Purple Chuckola Fruit", 0x24ED74, 0x24ED74, 1),
]
...
castleTown: typing.List[LocationData] = [
    ...
    LocationData("Beanbean Castle Peach's Extra Dress", 0x1E9433, 0x1E9433, 2),
    LocationData("Beanbean Castle Fake Beanstar", 0x1E9432, 0x1E9432, 2),
    LocationData("Beanbean Castle Town Beanlet 1", 0x251347, 0x251347, 1),
    LocationData("Beanbean Castle Town Beanlet 2", 0x2513FB, 0x2513FB, 1),
    LocationData("Beanbean Castle Town Beanlet 3", 0x2513A1, 0x2513A1, 1),
    LocationData("Beanbean Castle Town Beanlet 4", 0x251988, 0x251988, 1),
    LocationData("Beanbean Castle Town Beanlet 5", 0x25192E, 0x25192E, 1),
    LocationData("Beanbean Castle Town Beanstone 1", 0x25117D, 0x25117D, 1),
    LocationData("Beanbean Castle Town Beanstone 2", 0x2511D6, 0x2511D6, 1),
    LocationData("Beanbean Castle Town Beanstone 3", 0x25122F, 0x25122F, 1),
    LocationData("Beanbean Castle Town Beanstone 4", 0x251288, 0x251288, 1),
    LocationData("Beanbean Castle Town Beanstone 5", 0x2512E1, 0x2512E1, 1),
    LocationData("Beanbean Castle Town Beanstone 6", 0x25170B, 0x25170B, 1),
    LocationData("Beanbean Castle Town Beanstone 7", 0x251767, 0x251767, 1),
    LocationData("Beanbean Castle Town Beanstone 8", 0x2517C3, 0x2517C3, 1),
    LocationData("Beanbean Castle Town Beanstone 9", 0x25181F, 0x25181F, 1),
    LocationData("Beanbean Castle Town Beanstone 10", 0x25187B, 0x25187B, 1),
    LocationData("Coffee Shop Brew Reward 1", 0x253515, 0x253515, 1),
    LocationData("Coffee Shop Brew Reward 2", 0x253776, 0x253776, 1),
    LocationData("Coffee Shop Brew Reward 3", 0x253C70, 0x253C70, 1),
    LocationData("Coffee Shop Brew Reward 4", 0x254324, 0x254324, 1),
    LocationData("Coffee Shop Brew Reward 5", 0x254718, 0x254718, 1),
    LocationData("Coffee Shop Brew Reward 6", 0x254A34, 0x254A34, 1),
    LocationData("Coffee Shop Brew Reward 7", 0x254E24, 0x254E24, 1),
    LocationData("Coffee Shop Woohoo Blend", 0x252D07, 0x252D07, 1),
    LocationData("Coffee Shop Hoohoo Blend", 0x252D28, 0x252D28, 1),
    LocationData("Coffee Shop Chuckle Blend", 0x252D49, 0x252D49, 1),
    LocationData("Coffee Shop Teehee Blend", 0x252D6A, 0x252D6A, 1),
    LocationData("Coffee Shop Hoolumbian", 0x252D8B, 0x252D8B, 1),
    LocationData("Coffee Shop Chuckoccino", 0x252DAC, 0x252DAC, 1),
    LocationData("Coffee Shop Teeheespresso", 0x252DCD, 0x252DCD, 1),
    LocationData("Beanbean Castle Town Beanstone Reward", 0x251071, 0x251071, 1),
    LocationData("Beanbean Castle Town Beanlet Reward", 0x2515EB, 0x2515EB, 1),
]
...
startingFlag: typing.List[LocationData] = [
    LocationData("Badge Shop Starting Flag 1", 0x3C0618, 0x3C0618, 2),
    LocationData("Badge Shop Starting Flag 2", 0x3C061A, 0x3C061A, 2),
    LocationData("Pants Shop Starting Flag 1", 0x3C061C, 0x3C061C, 2),
    LocationData("Pants Shop Starting Flag 2", 0x3C061E, 0x3C061E, 2),
    LocationData("Pants Shop Starting Flag 3", 0x3C0620, 0x3C0620, 2),
]

chuckolatorFlag: typing.List[LocationData] = [
    LocationData("Shop Chuckolator Flag", 0x3C05F8, 0x3C05F8, 3),
    LocationData("Pants Shop Chuckolator Flag 1", 0x3C062A, 0x3C062A, 2),
    LocationData("Pants Shop Chuckolator Flag 2", 0x3C062C, 0x3C062C, 2),
    LocationData("Pants Shop Chuckolator Flag 3", 0x3C062E, 0x3C062E, 2),
    LocationData("Badge Shop Chuckolator Flag 1", 0x3C0624, 0x3C0624, 2),
    LocationData("Badge Shop Chuckolator Flag 2", 0x3C0626, 0x3C0626, 2),
    LocationData("Badge Shop Chuckolator Flag 3", 0x3C0628, 0x3C0628, 2),
]

piranhaFlag: typing.List[LocationData] = [
    LocationData("Shop Mom Piranha Flag 1", 0x3C05FC, 0x3C05FC, 3),
    LocationData("Shop Mom Piranha Flag 2", 0x3C05FE, 0x3C05FE, 3),
    LocationData("Shop Mom Piranha Flag 3", 0x3C0600, 0x3C0600, 3),
    LocationData("Shop Mom Piranha Flag 4", 0x3C0602, 0x3C0602, 3),
    LocationData("Pants Shop Mom Piranha Flag 1", 0x3C0638, 0x3C0638, 2),
    LocationData("Pants Shop Mom Piranha Flag 2", 0x3C063A, 0x3C063A, 2),
    LocationData("Pants Shop Mom Piranha Flag 3", 0x3C063C, 0x3C063C, 2),
    LocationData("Badge Shop Mom Piranha Flag 1", 0x3C0632, 0x3C0632, 2),
    LocationData("Badge Shop Mom Piranha Flag 2", 0x3C0634, 0x3C0634, 2),
    LocationData("Badge Shop Mom Piranha Flag 3", 0x3C0636, 0x3C0636, 2),
]

kidnappedFlag: typing.List[LocationData] = [
    LocationData("Badge Shop Trunkle Flag 1", 0x3C0640, 0x3C0640, 2),
    LocationData("Badge Shop Trunkle Flag 2", 0x3C0642, 0x3C0642, 2),
    LocationData("Badge Shop Trunkle Flag 3", 0x3C0644, 0x3C0644, 2),
    LocationData("Pants Shop Trunkle Flag 1", 0x3C0646, 0x3C0646, 2),
    LocationData("Pants Shop Trunkle Flag 2", 0x3C0648, 0x3C0648, 2),
    LocationData("Pants Shop Trunkle Flag 3", 0x3C064A, 0x3C064A, 2),
    LocationData("Shop Trunkle Flag 1", 0x3C0606, 0x3C0606, 3),
    LocationData("Shop Trunkle Flag 2", 0x3C0608, 0x3C0608, 3),
]

beanstarFlag: typing.List[LocationData] = [
    LocationData("Badge Shop Beanstar Complete Flag 1", 0x3C064E, 0x3C064E, 2),
    LocationData("Badge Shop Beanstar Complete Flag 2", 0x3C0650, 0x3C0650, 2),
    LocationData("Badge Shop Beanstar Complete Flag 3", 0x3C0652, 0x3C0652, 2),
    LocationData("Pants Shop Beanstar Complete Flag 1", 0x3C0654, 0x3C0654, 2),
    LocationData("Pants Shop Beanstar Complete Flag 2", 0x3C0656, 0x3C0656, 2),
    LocationData("Pants Shop Beanstar Complete Flag 3", 0x3C0658, 0x3C0658, 2),
    LocationData("Shop Beanstar Complete Flag 1", 0x3C060C, 0x3C060C, 3),
    LocationData("Shop Beanstar Complete Flag 2", 0x3C060E, 0x3C060E, 3),
    LocationData("Shop Beanstar Complete Flag 3", 0x3C0610, 0x3C0610, 3),
]

birdoFlag: typing.List[LocationData] = [
    LocationData("Badge Shop Birdo Flag 1", 0x3C065C, 0x3C065C, 2),
    LocationData("Badge Shop Birdo Flag 2", 0x3C065E, 0x3C065E, 2),
    LocationData("Badge Shop Birdo Flag 3", 0x3C0660, 0x3C0660, 2),
    LocationData("Pants Shop Birdo Flag 1", 0x3C0662, 0x3C0662, 2),
    LocationData("Pants Shop Birdo Flag 2", 0x3C0664, 0x3C0664, 2),
    LocationData("Pants Shop Birdo Flag 3", 0x3C0666, 0x3C0666, 2),
    LocationData("Shop Birdo Flag", 0x3C0614, 0x3C0614, 3),
]
...
winkle: typing.List[LocationData] = [
    ...
    LocationData("Beanstar Piece Winkle Area", 0x1E9440, 0x1E9440, 2),
    LocationData("Winkle Area Winkle Card", 0x261658, 0x261658, 1),
]
...
sewers: typing.List[LocationData] = [
    ...
    LocationData("Beanbean Castle Beanbean Brooch", 0x2578E7, 0x2578E7, 1),
]
...
surfable: typing.List[LocationData] = [
    ...
    LocationData("Surf Minigame", 0x2753EA, 0x2753EA, 1),
    LocationData("North Ocean Whirlpool Mole", 0x277956, 0x277956, 1),
...
gwarharEntrance: typing.List[LocationData] = [
    ...
    LocationData("Gwarhar Lagoon Red Pearl Bean", 0x235C1C, 0x235C1C, 1),
    LocationData("Gwarhar Lagoon Green Pearl Bean", 0x235A5B, 0x235A5B, 1),
...
gwarharMain: typing.List[LocationData] = [
    ...
    LocationData("Gwarhar Lagoon Spangle Reward", 0x236E73, 0x236E73, 1),
    LocationData("Beanstar Piece Hermie", 0x1E9443, 0x1E9443, 2),
    LocationData("Gwarhar Lagoon Spangle", 0x1E9437, 0x1E9437, 2),
]
...
teeheeValley: typing.List[LocationData] = [
    ...
    LocationData("S.S. Chuckola Membership Card", 0x260637, 0x260637, 1),
]
...
fungitown: typing.List[LocationData] = [
    ...
    LocationData("Fungitown Badge Shop Starting Flag 1", 0x3C0684, 0x3C0684, 2),
    LocationData("Fungitown Badge Shop Starting Flag 2", 0x3C0686, 0x3C0686, 2),
    LocationData("Fungitown Badge Shop Starting Flag 3", 0x3C0688, 0x3C0688, 2),
    LocationData("Fungitown Shop Starting Flag 1", 0x3C066A, 0x3C066A, 3),
    LocationData("Fungitown Shop Starting Flag 2", 0x3C066C, 0x3C066C, 3),
    LocationData("Fungitown Shop Starting Flag 3", 0x3C066E, 0x3C066E, 3),
    LocationData("Fungitown Shop Starting Flag 4", 0x3C0670, 0x3C0670, 3),
    LocationData("Fungitown Shop Starting Flag 5", 0x3C0672, 0x3C0672, 3),
    LocationData("Fungitown Shop Starting Flag 6", 0x3C0674, 0x3C0674, 3),
    LocationData("Fungitown Shop Starting Flag 7", 0x3C0676, 0x3C0676, 3),
    LocationData("Fungitown Shop Starting Flag 8", 0x3C0678, 0x3C0678, 3),
    LocationData("Fungitown Pants Shop Starting Flag 1", 0x3C068A, 0x3C068A, 2),
    LocationData("Fungitown Pants Shop Starting Flag 2", 0x3C068C, 0x3C068C, 2),
    LocationData("Fungitown Pants Shop Starting Flag 3", 0x3C068E, 0x3C068E, 2),
]

fungitownBeanstar: typing.List[LocationData] = [
    LocationData("Fungitown Badge Shop Beanstar Complete Flag 1", 0x3C0692, 0x3C0692, 2),
    LocationData("Fungitown Badge Shop Beanstar Complete Flag 2", 0x3C0694, 0x3C0694, 2),
    LocationData("Fungitown Pants Shop Beanstar Complete Flag 1", 0x3C0696, 0x3C0696, 2),
    LocationData("Fungitown Pants Shop Beanstar Complete Flag 2", 0x3C0698, 0x3C0698, 2),
    LocationData("Fungitown Shop Beanstar Complete Flag", 0x3C067C, 0x3C067C, 3),
]

fungitownBirdo: typing.List[LocationData] = [
    LocationData("Fungitown Shop Birdo Flag", 0x3C0680, 0x3C0680, 3),
    LocationData("Fungitown Pants Shop Birdo Flag 1", 0x3C06A0, 0x3C06A0, 2),
    LocationData("Fungitown Pants Shop Birdo Flag 2", 0x3C06A2, 0x3C06A2, 2),
    LocationData("Fungitown Badge Shop Birdo Flag 1", 0x3C069C, 0x3C069C, 2),
    LocationData("Fungitown Badge Shop Birdo Flag 2", 0x3C069E, 0x3C069E, 2),
]
...
bowsers: typing.List[LocationData] = [
    ...
    LocationData("Bowser's Castle Lemmy Room Mole", 0x277B1F, 0x277B1F, 1),
]
...
jokesEntrance: typing.List[LocationData] = [
    ...
    LocationData("Joke's End Mole Reward 1", 0x27788E, 0x27788E, 1),
    LocationData("Joke's End Mole Reward 2", 0x2778D2, 0x2778D2, 1),
...
theater: typing.List[LocationData] = [
    LocationData("Yoshi Theater Blue Yoshi", 0x241155, 0x241155, 1),
    LocationData("Yoshi Theater Red Yoshi", 0x240EBE, 0x240EBE, 1),
    LocationData("Yoshi Theater Green Yoshi", 0x241AFA, 0x241AFA, 1),
    LocationData("Yoshi Theater Yellow Yoshi", 0x241C3C, 0x241C3C, 1),
    LocationData("Yoshi Theater Purple Yoshi", 0x241297, 0x241297, 1),
    LocationData("Yoshi Theater Orange Yoshi", 0x241000, 0x241000, 1),
    LocationData("Yoshi Theater Azure Yoshi", 0x241D7E, 0x241D7E, 1),
    LocationData("Beanstar Piece Yoshi Theater", 0x1E9442, 0x1E9442, 2),
]
...
oasis: typing.List[LocationData] = [
    ...
    LocationData("Oho Oasis Firebrand", 0x1E9408, 0x1E9408, 2),
    LocationData("Oho Oasis Thunderhand", 0x1E9409, 0x1E9409, 2),
]
